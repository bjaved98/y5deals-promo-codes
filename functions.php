...
if ( ! function_exists( 'wpcoupon_theme_setup' ) ) :
	...
	function wpcoupon_theme_setup() {
		 ...
		 * If you're building a theme based on wp-coupon-mate, use a find and replace
		 * to change 'wp-coupon-mate' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'wp-coupon-mate', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'primary' => esc_html__( 'Primary', 'wp-coupon-mate' ),
				'footer' => esc_html__( 'Footer', 'wp-coupon-mate' ),
			)
		);
...
function wpcoupon_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Blog Sidebar', 'wp-coupon-mate' ),
			'id'            => 'sidebar',
			'description'   => '',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Page Sidebar', 'wp-coupon-mate' ),
			'id'            => 'sidebar-2',
			'description'   => '',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Coupon Category Sidebar', 'wp-coupon-mate' ),
			'id'            => 'sidebar-coupon-category',
			'description'   => esc_html__( 'The sidebar will display on coupon category, tag page.', 'wp-coupon-mate' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="widget-title">',
			'after_title'   => '</h4>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Store Sidebar', 'wp-coupon-mate' ),
			'id'            => 'sidebar-store',
			// 'description'   => esc_html__( 'The sidebar will display on single store, coupon category.', 'wp-coupon-mate' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h4 class="widget-title">',
			'after_title'   => '</h4>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'WooCommerce Sidebar', 'wp-coupon-mate' ),
			'id'            => 'sidebar-woo',
			'description'   => '',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Frontpage Before Main Content', 'wp-coupon-mate' ),
			'id'            => 'frontpage-before-main',
			'description'   => esc_html__( 'This sidebar display on frontpage template', 'wp-coupon-mate' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Frontpage Main Content', 'wp-coupon-mate' ),
			'id'            => 'frontpage-main',
			'description'   => esc_html__( 'This sidebar display on frontpage template', 'wp-coupon-mate' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
...
//	register_sidebar(
//		array(
//			'name'          => esc_html__( 'Frontpage Main Sidebar', 'wp-coupon-mate' ),
...
//	);
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Frontpage After Main Content', 'wp-coupon-mate' ),
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Storepage After Extra Content', 'wp-coupon-mate' ),
			'id'            => 'storepage-after-extra-content',
			'description'   => esc_html__( 'This sidebar display on after store page', 'wp-coupon-mate' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
...
function wpcoupon_theme_scripts() {
	...
	$localize = array(
		...
		'added_favorite'  => esc_html__( 'Favorited', 'wp-coupon-mate' ),
		'add_favorite'    => esc_html__( 'Favorite This Store', 'wp-coupon-mate' ),
		'login_warning'   => esc_html__( 'Please login to continue...', 'wp-coupon-mate' ),
		'save_coupon'     => esc_html__( 'Save this coupon', 'wp-coupon-mate' ),
		'saved_coupon'    => esc_html__( 'Coupon Saved', 'wp-coupon-mate' ),
		'no_results'      => esc_html__( 'No results...', 'wp-coupon-mate' ),
		'copied'          => esc_html__( 'Copied', 'wp-coupon-mate' ),
		'copy'            => esc_html__( 'Copy', 'wp-coupon-mate' ),
...
function wpcoupon_get_coupon_types( $plural = false ) {
	...
	if ( $plural ) {
		$types = array(
			'code'       => esc_html__( 'Codes', 'wp-coupon-mate' ),
			'sale'       => esc_html__( 'Sales', 'wp-coupon-mate' ),
			'print'      => esc_html__( 'Printable', 'wp-coupon-mate' ),
		);
		if ( $deal ) {
			$types['sale'] = esc_html__( 'Deals', 'wp-coupon-mate' );
		}
	} else {
		$types = array(
			'code'       => esc_html__( 'Code', 'wp-coupon-mate' ),
			'sale'       => esc_html__( 'Sale', 'wp-coupon-mate' ),
			'print'      => esc_html__( 'Printable', 'wp-coupon-mate' ),
		);
		if ( $deal ) {
			$types['sale'] = esc_html__( 'Deal', 'wp-coupon-mate' );
		}
	}
...
require_once get_template_directory() . '/inc/widgets/category-gridview.php';
